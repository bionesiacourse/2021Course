...
This workshop introduces methods, tools, and software for reproducibly managing, manipulating, analyzing, and visualizing large-scale biomedical data using the R statistical computing environment. [More below in the FAQ](#faq).

## General Information

**_When_: June 2017.** Classroom dates are reserved all day June 14, 15, 20, 21, 22. **We will not use all day, all five days. Course dates/times will be updated shortly**.
...
<mark>**_Note, work in progress, check back later..._**</mark>
...
#### Session 4: Reproducible Research & Dynamic Documents
...
#### Session 5: Introduction to RNA-seq Data Analysis
...
#### Session 6: TBA, some kind of microbial genomics analysis
