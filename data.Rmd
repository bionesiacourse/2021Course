...
if (!file.exists("data.zip")) system("zip -r data.zip data -x '*.html'")
```

<big><mark>**_PLEASE NOTE THAT THE DATA SETS YOU MAY NEED ARE INCOMPLETE AS OF JUNE 1 2017. THEY WILL BE UPDATED PRIOR TO THE COURSE, AND YOU WILL BE NOTIFIED. PLEASE DON'T WORRY ABOUT COMPLETING THIS JUST YET._**</mark></big>
