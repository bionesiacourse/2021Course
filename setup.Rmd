...
![](/Users/IBRC/Downloads/anatomyofrstudio.png)  
...
![](/Users/IBRC/Desktop/library.png)
$$\\[0.05in]$$
...
```{r}
data <- read.csv("/Users/IBRC/Downloads/datafile.txt")
head (data) 
...
library(readxl)
data <- read_excel("/Users/IBRC/Downloads/datafile.xlsx", 1)
head(data)
```
...
![](/Users/IBRC/Desktop/import_f2.png) 
![](/Users/IBRC/Desktop/import_f1.png)
...
![](/Users/IBRC/Downloads/chart-chooser-data-visualization.png)
$$\\[0.2in]$$
...
![](/Users/IBRC/Downloads/FIG-SCATTER-SHAPES-CHART-1.png)
...
![](/Users/IBRC/Downloads/theeconomist.png)
